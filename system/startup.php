...
// Проверка и загрузка глобальных конфигураций
if (!is_file(DIR_SYSTEM . 'config/system.php')) trigger_error("Отсутсвует файл конфигураций: system.php",E_USER_ERROR);
...
// Проверка наличия модификации
function modification($filename) {
    $file = preg_replace("/\.php$/",'.mod.php',$filename);
    if(is_file($file)){
        return $file;
    }
...
require_once(modification(DIR_SYSTEM . 'engine/language.php'));
